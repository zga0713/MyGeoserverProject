...
cur.execute("DROP TABLE IF EXISTS public.v6_time_pref_pts_utf_wgs84 CASCADE;")
cur.execute('''--建表
...
# 插入数据
f=open(r'c:\Users\zhou0\Desktop\MyGeoserverProject\data\V6 Time Series Prefecture Points\v6_time_pref_pts_utf_wgs84\v6_time_pref_pts_utf_wgs84.txt','r',encoding='utf-8')
# 按行读入txt
flines=f.readlines()
for line in flines:
    # 去掉干扰，切词
