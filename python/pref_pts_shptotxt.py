...
if __name__ == '__main__':
    result=ReadVectorFile(r'c:\Users\zhou0\Desktop\MyGeoserverProject\data\V6 Time Series Prefecture Points\v6_time_pref_pts_utf_wgs84\v6_time_pref_pts_utf_wgs84.shp')
    f_new=open(r'c:\Users\zhou0\Desktop\MyGeoserverProject\data\V6 Time Series Prefecture Points\v6_time_pref_pts_utf_wgs84\v6_time_pref_pts_utf_wgs84.txt','a',encoding='utf-8')
    for r in result:
        for p in r:
            f_new.write(p+'\t')
        f_new.write('\n')
